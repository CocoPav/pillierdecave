...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UserBox", mappedBy="user")
     */
    private $userBoxes;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Alcohol", inversedBy="users")
     */
    private $alcohols;
